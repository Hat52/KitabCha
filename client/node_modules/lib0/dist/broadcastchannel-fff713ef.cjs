...
var encoding = require('./buffer-621617f6.cjs');
...
class LocalStoragePolyfill {
  ...
  constructor (room) {
     ...
     * @param {any} e
     */
    this._onChange = e => e.key === room && this.onmessage !== null && this.onmessage({ data: encoding.fromBase64(e.newValue || '') });
...
//# sourceMappingURL=broadcastchannel-fff713ef.cjs.map
